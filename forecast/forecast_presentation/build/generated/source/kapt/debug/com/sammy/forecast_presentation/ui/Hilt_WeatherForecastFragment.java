 ...
 */
public abstract class Hilt_WeatherForecastFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WeatherForecastFragment() {
    super();
  }

  Hilt_WeatherForecastFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WeatherForecastFragment_GeneratedInjector) this.generatedComponent()).injectWeatherForecastFragment(UnsafeCasts.<WeatherForecastFragment>unsafeCast(this));
    }
  }
